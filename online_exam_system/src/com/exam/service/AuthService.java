	...
	public boolean findUser(String uname,String upwd) {
		...
		try {
			...
			if(userObj != null && userObj.size() > 0) {
				log.info("Id= " + userObj.get(0).getId() + ", Name= " + userObj.get(0).getUserName() + ", Password= " + userObj.get(0).getPassWord());
				isValidUser = true;
			}
		} catch(Exception e) {
			isValidUser = false;
...
/*\\INSERT INTO users (id, email, password) VALUES ('0', 'abc@gmail.com', 'Norway');
//SELECT password FROM users WHERE email='abc@gmail.com'*/